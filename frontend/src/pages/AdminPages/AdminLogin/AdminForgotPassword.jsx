...
import "./AdminForgotPassword.css"; // CSS for styling
...
const Password = () => {
  ...
  const handleEmailSubmit = (e) => {
    ...
    if (email) {
      fetch(`${import.meta.env.VITE_BACKEND_URL}/admin/reset-password-email-verification`, {
            method: 'POST',
            headers: {
  ...
  const handleOtpSubmit = (e) => {
    ...
    fetch(`import.meta.env.VITE_BACKEND_URL/admin/reset-password`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
